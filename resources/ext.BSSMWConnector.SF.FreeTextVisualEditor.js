mw.loader.using('ext.bluespice.visualEditor.tinymce').done(function () {
	...
	mw.loader.using(BsVisualEditorLoaderUsingDeps).done(function () {
		...
		//Remove bsautoresize plugin
		var extPlugins = BsVisualEditorConfigDefault.external_plugins;
		if( extPlugins.bsautoresize ) {
			delete( extPlugins['bsautoresize'] );
		}
